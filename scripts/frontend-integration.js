 ...
 * This file demonstrates how to integrate Nexusweaver with a web frontend
 */

// For React/Vue/Angular applications
export class NexusweaverClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NexusweaverClient(provider, contractAddress);
