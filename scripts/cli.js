...
const contractABI = require("../artifacts/contracts/Nexusweaver.sol/Nexusweaver.json").abi;

program
    .name("nexusweaver-cli")
    .description("CLI tool for Nexusweaver smart contract")
    .version("1.0.0");
